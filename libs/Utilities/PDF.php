<style type="text/css">
    ...
    div.special { margin: auto; width:95%; padding: 2px 0px; }
        ...
        <div class="special">
            <table>
                <tr>
                    ...
                    <td style="width: 5%;font-size: 14px" class="bottomRight"><?php echo $Estudiante["enrollment"]['id'] ?></td>
                    ...
                    <td  style="width: 15%; height:10px;">
                        <div style="display:flex;text-align:bottom;">
                            <strong> <span style="font-size: 16px;margin-left: 20px;padding-top:15px;">Seccion</span></strong>
                        </div>
                    </td>
                    <td style="width: 5%;text-align:center; padding-top: 5px;" class="bottomRight"><?php echo $Estudiante["enrollment"]["section"] ?></td>
                </tr>
            </table>
        </div>
        <br/>
        <div class="special">
            <table>
                <tr>
                    ...
                    <td style="width: 8%;"> <strong> <span style="font-size: 14px;">Fecha:</span></strong></td>

                    <td style="width: 10%;font-size: 14px" class="bottomRight"><?php echo $Estudiante["enrollment"]["_date"] ?></td>

                    <td style="width: 10%;"></td>

                    <td style="width: 25%;text-align:right;"> <strong> <span style="font-size: 14px;">Nivel a Matricular:</span></strong></td>

                    <td style="width: 4%;font-size: 14px; text-align: center" class="bottomRight"><?php echo $Estudiante["enrollment"]["degree"] ?></td>

                    <td style="width: 25%;text-align:right;"><strong> <span style="font-size: 14px;">Taller(7°, 8° y 9°):</span></strong></td>

                    <td style="width: 15%; text-align: center" class="bottomRight"><?php echo $Estudiante["workshop789"] ?></td>
                </tr>
            ...
            <table >
                ...
                <tr>
                    ...
                    <td style="width: 10%;text-align:center; padding-top: 20px;" class="bottomRight"><?php echo $Estudiante["workshop11"] ?></td>
                </tr>
            ...
            <table >
                <tr>
                    <td style="width: 20%;text-align:center;" class="bottomRight"><?php echo $Estudiante["first_lastname"] ?></td>
                    <td style="width: 5%;"></td>
                    <td style="width: 20%;text-align:center;" class="bottomRight"><?php echo $Estudiante["second_lastname"] ?></td>
                    <td style="width: 5%;"></td>
                    <td style="width: 20%;text-align:center;" class="bottomRight"><?php echo $Estudiante["name"] ?></td>
                    <td style="width: 5%;"></td>
                    <td style="width: 20%;text-align:center;" class="bottomRight"><?php echo $Estudiante["card"] ?></td>
                </tr>
                <tr>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 21%;height:10px;text-align:left;">
                        ...
                        <p style="font-size: 14px;margin-top:15px;">Fecha de nacimiento:</p>

                    </td>
                    <td style="width: 12%;;" class="bottomRight">
                        <p style="margin-left: 0px;margin-top:15px; text-align: center"><?php echo $Estudiante["birthdate"] ?></p></td>
                    <td style="width: 7%;height:10px;text-align:bottom;">

                        <p style="font-size: 14px;margin-left: 15px;margin-top:15px;">Edad:</p>

                    </td>
                    <td style="width: 10%;margin-left: 0px; text-align: center" class="bottomRight"><p style="margin-left: 0px;margin-top:15px;"><?php echo $Estudiante["age"] ?></p></td>
                    <td style="width: 11%;height:10px;text-align:bottom;">

                        <p style="font-size: 14px;margin-left: 15px;margin-top:15px;">Años y</p>

                    </td>
                    <td style="width: 5%; text-align: center" class="bottomRight"><p style="margin-left: 0px;margin-top:15px;"><?php echo $Estudiante["months"] ?></p></td>
                    <td style="width: 10%;height:10px;text-align:bottom;">

                        <p style="font-size: 14px;margin-left: 0px;margin-top:15px;">Meses.</p>

                    </td>
                    <td style="width: 7%;height:10px;text-align:bottom;">

                        <p style="font-size: 14px;margin-left: 15px;margin-top:15px;">Sexo:</p>
                    ...
                    <td style="width: 20%;" class="">
                        ...
                        <div style="display:inline-block;margin-top:15px;">
                            ...
                            <label style="font-size: 14px;"><?php
                                if ($Estudiante["gender"] === "F" || $Estudiante["gender"] == "1") {
                                    echo "(x)";
                                } else {
                                    echo "()";
                                }
                            ...
                            <label style="margin-left:15px;font-size: 14px;"><?php
                                if ($Estudiante["gender"] === "M" || $Estudiante["gender"] == "0") {
                                    echo "(x)";
                                } else {
                                    echo "()";
                                }
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 25%; text-align: center" class="bottomRight"><p style="margin-left: 0px;margin-top:15px;"><?php echo $Estudiante["nationality"] ?></p></td>
                    ...
                    <td style="width: 25%; text-align: center" class="bottomRight"><p style="margin-left: 0px;margin-top:15px;"><?php echo $Estudiante["other_phone"] ?></p></td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 35%; text-align: center" class="bottomRight"><p style="margin-left: 0px;margin-top:15px;"><?php echo $Estudiante["mep_mail"] ?></p></td>
                    <td style="width: 25%;height:10px;text-align:bottom;;">

                        <p style="font-size: 14px;margin-left: 35px;">Teléfono estudiante:</p>

                    </td>
                    <td style="width: 20%; text-align: center" class="bottomRight"><p style="margin-left: 0px;margin-top:15px;"><?php echo $Estudiante["personal_phone"] ?></p></td>
                </tr>
            </table>
            ...
            <table >
                <tr>
                    ...
                    <td style="width: 15%;text-align:center;" class="bottomRight"><p style="margin-left: 0px;margin-top:15px;">Limón</p></td>
                    <td style="width: 5%;"></td>
                    <td style="width: 15%;text-align:center;" class="bottomRight"><p style="margin-left: 0px;margin-top:15px;">Pococí</p></td>
                    <td style="width: 5%;"></td>
                    <td style="width: 15%;text-align:center;" class="bottomRight"><p style="margin-left: 0px;margin-top:15px;"><?php echo $Estudiante["district"] ?></p></td>
                    <td style="width: 5%;"></td>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 65%;" class="bottomRight"><p style="margin-left: 0px;margin-top:15px;"><?php echo $Estudiante["direction"] ?></p></td>
                ...
                <tr>
                    ...
                    <td style="width: 20%;" class="">
                        ...
                        <div style="display:inline-block;margin-top:10px;">
                            ...
                            <label style="margin-left:15px;font-size: 14px;"><?php
                                if (strlen($Estudiante["suffering"]) == "0") {
                                    echo "(x)";
                                } else {
                                    echo "()";
                                }
                    ...
                    <td style="width: 30%;" class="bottomRight">
                        <p style="margin-left: 0px;margin-top:15px;"><?php echo $Estudiante["suffering"] ?></p>
                    </td>
            ...
            <table>
                <tr>  
                    <td style="width: 35%;text-align:left;height:15px;" >
                        <span style="font-size: 14px;margin-left: 15px;"><p>Tiene adecuación curricular aprobada:</p></span>
                    </td>
                    <td style="width: 20%;" class="">
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 30%;text-align: center" class="bottomRight"><p style="margin-left: 15px;margin-top:15px;"><?php echo $Estudiante["contact_name"] ?></p></td>
                    <td style="width: 15%;height:10px;text-align:bottom;">

                        <p style="font-size: 14px;margin-left: 35px;">Teléfono:</p>

                    </td>
                    <td style="width: 17%;text-align: center" class="bottomRight"><p style="margin-left: 0px;margin-top:15px;"><?php echo $Estudiante["contact_phone"] ?></p></td>
                </tr>
            </table>
            <table >
            ...
            <table>
                <tr>
                    <td style="width: 20%;text-align:left;height:15px;" >
                        <span style="font-size: 14px;margin-left: 15px;"><p> Nombre Completo:</p></span>
                    </td>
                    <td style="width: 65%;" class="bottomRight"><p style="margin-left: 0px;margin-top:15px;"><?php echo $Estudiante["parent"]["full_name"] ?></p></td>
            ...
            <table >
                <tr>
                    ...
                    <td style="width: 30%;text-align: center" class="bottomRight"><p style="margin-left: 15px;margin-top:15px;"><?php echo $Estudiante["parent"]["card"] ?></p></td>
                    <td style="width: 15%;height:10px;text-align:bottom;">

                        <p style="font-size: 14px;margin-left: 35px;">Teléfono:</p>

                    </td>
                    <td style="width: 17%;text-align: center" class="bottomRight"><p style="margin-left: 15px;margin-top:15px;"><?php echo $Estudiante["parent"]["phone"] ?></p></td>
                </tr>
            </table>
            <table>
                <tr>
                    ...
                    <td style="width: 30%;text-align: center" class="bottomRight"><p style="padding-top: 5px;margin-top:10px;"><?php echo $Estudiante["parent"]["ocupation"] ?></p></td>
                    <td style="width: 25%;text-align:bottom;">

                        <p style="font-size: 14px;margin-left: 35px;">Lugar de Trabajo:</p>

                    </td>
                    <td style="width: 17%;text-align: center" class="bottomRight"><p style="padding-top: 5px;margin-top:10px;"><?php echo $Estudiante["parent"]["work_place"] ?></p></td>
                </tr>
            </table>
        </div>
    </div>
    <div class="footer" style=";margin-top:0px;">
        ...
        <div style="width: 100%; border: solid 1px #000000;  font-size: 4mm; line-height: 150%;">
            ...
            <div style="display:inline-block;">
                ...
                <label for="op1"  style="margin-left:20px;">Español</label>
                <label >(<?php echo $cursosReprobados[0]["checked"] ?>) </label>

                <label for="op2" style="margin-left:20px;"> Ciencias</label>
                <label >(<?php echo $cursosReprobados[1]["checked"] ?>) </label>

                <label for="op3" style="margin-left:20px;"> Estudios Sociales</label>
                <label >(<?php echo $cursosReprobados[2]["checked"] ?>) </label>

                <label for="op4" style="margin-left:20px;"> Matemática</label>
                <label >(<?php echo $cursosReprobados[3]["checked"] ?>) </label>

                <label for="op5" style="margin-left:20px;"> Inglés</label>
                <label >(<?php echo $cursosReprobados[4]["checked"] ?>) </label>

                <label for="op6" style="margin-left:20px;"> Cívica</label>
                <label >(<?php echo $cursosReprobados[5]["checked"] ?>) </label> <br>

                <label for="op8"  style="margin-left:20px;">Ética</label>
                <label >(<?php echo $cursosReprobados[6]["checked"] ?>) </label>

                <label for="op7" style="margin-left:20px;"> Taller III ciclo</label>
                <label >(<?php echo $cursosReprobados[10]["checked"] ?>) </label>

                <label for="op9" style="margin-left:20px;"> Química</label>
                <label >(<?php echo $cursosReprobados[7]["checked"] ?>) </label>

                <label for="op11" style="margin-left:20px;"> Física</label>
                <label >(<?php echo $cursosReprobados[8]["checked"] ?>) </label>

                <label for="op10" style="margin-left:20px;"> Biología</label>
